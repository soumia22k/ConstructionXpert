    ...
    <div class="row">
        <div class="col-md-4">
            <div class="feature-box text-white">
                ...
                <img src="assets/images/planning.jpg" class="img-fluid1" alt="Planification">
            </div>
        </div>
        <div class="col-md-4">
            <div class="feature-box text-white">
                <h4>Suivi et collaboration en temps réel :</h4>
                <img src="assets/images/collaboration.jpg" class="img-fluid2" alt="Collaboration">
            </div>
        </div>
        <div class="col-md-4">
            <div class="feature-box text-white">
                <h4>Reporting et analyse des performances :</h4>
                <img src="assets/images/reporting.jpg" class="img-fluid3" alt="Reporting">
            </div>
        </div>
    </div>
</div>
