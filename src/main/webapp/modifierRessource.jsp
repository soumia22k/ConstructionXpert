                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nomRessource" class="form-control" value="${resource.nomRessource}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Type de Ressource</label>
                                <input type="text" name="typeRessource" class="form-control" value="${resource.typeRessource}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Quantité</label>
                                <input type="number" name="quantite" class="form-control" value="${resource.quantite}" required>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Mettre à jour</button>
                        <a href="listeRessource.jsp" class="btn btn-secondary">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
